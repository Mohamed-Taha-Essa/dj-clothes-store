...
def home(request):
    ...
    new_product1 = Product.objects.filter(flag ='New')[10:20]
    # sale_product = Product.objects.filter(flag ='Sale').annotate(review_count = Count('review_product'))[:10]
    sale_product1 = Product.objects.filter(flag ='Sale')[10:20]
   
    feature_product1 = Product.objects.filter(flag ='Feature')[7:17]
...
'''
    return render(request ,'settings/home.html',{
        ...
        'sale_product1':sale_product1,
        'feature_product1':feature_product1,
    })